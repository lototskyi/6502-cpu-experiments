...
reset:
 ...
 ; Initialize SPI
 lda #%00000111    ; nc/miso/nc/nc/nc/cs/sck/mosi
 sta DDRA
 
 stz PORTA
 lda #%11010000         ; Send D0 instruction
 jsr spi_transceive
...
loop:
 ...
 stz PORTA
 lda #$fa
 jsr spi_transceive		; Send FA address
 jsr spi_transceive		; Read result into A
 sta value + 1
 jsr spi_transceive		; Read result into A
 sta value  
...
spi_loop:
 ...
 trb PORTA       ; MSB was 0, set MOSI low
 jmp spi_2
spi_1:
 tsb PORTA       ; MSB was 1, set MOSI high
spi_2:
 inc PORTA       ; Set SCK high
 bit PORTA       ; Put MISO into owerflow flag
...
spi_3:
 ...
 lda spiin       ; Done; put the received bdata into A
 clc
 rts
